...
#[export] Remove Hints Bool.trans_eq_bool.
...
Ltac lets_base I E := idtac E;generalize E; intros I.
...
let a := match goal with _ => idtac "lets  ";idtac args end in
...
Ltac forwards_build_app_arg Ei :=
  ...
  let a := match goal with _ => idtac args end in
  args.
